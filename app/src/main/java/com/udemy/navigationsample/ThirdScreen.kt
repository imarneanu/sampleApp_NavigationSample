...
@Composable
fun ThirdScreen(modifier: Modifier = Modifier, data: DataObject, navigateToFirstScreen: () -> Unit) {
    Column(
...
fun ThirdScreenPreview() {
    NavigationSampleTheme {
        ThirdScreen(Modifier.background(MaterialTheme.colorScheme.background), DataObject("Iulia", 37)) {}
    }
}
